...
from .utils import png2jpg, seconds_format, text_transform
...
async def append_merge_recall_list(msg):
	merge_recall_list.append({"type": "node", "data": {"name": "机器人的昵称", "uin": "机器人的QQ号", "content": msg}})
...
async def handle_receive(msg: dict) -> dict:
	...
	try:
		...
		if msg["type"] == "normal_task_report" or msg["type"] == "interrupt_task_report":
			...
			if (("notice" not in msg["task_config"]) or msg["task_config"]["notice"] is True) and config.get_config("maa_recall_enable"):
