...
class Config:
	def __init__(self) -> None:
		self.config_path = Path(__file__).parent / f'data/maa/config.json'
		self.tasks_config_path = Path(__file__).parent / f'data/maa/tasks_config.json'
		self.update_config_path = Path(__file__).parent / f'data/maa/tasks_update.json'
	...
	def get_template_task(self):
		with open(Path(__file__).parent / f'data/maa/tasks_template.json','r',encoding='utf8') as f:
			return json.load(f)
