...
class Asst:
	...
	def connect(self, adb_path: str, address: str, config: str = "CompatPOSIXShell"):
		...
		# 	None,
		# 	Asst.__lib.async_connect,
		# 	self.__ptr,  adb_path.encode('utf-8') ,
	...
	def __set_lib_properties():
		...
		Asst.__lib.AsstGetImage.restype = ctypes.c_int
		Asst.__lib.AsstGetImage.argtypes = (ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int)

		Asst.__lib.AsstAsyncScreencap.restype = ctypes.c_int
		Asst.__lib.AsstAsyncScreencap.argtypes = (ctypes.c_void_p, ctypes.c_bool)
		...
		Asst.__lib.AsstGetUUID.argtypes = (ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int)
